...
> Copie vendorisée par le module `frontend-web` de socle. Source : `anthropics/skills`, `skills/frontend-design/SKILL.md`, commit `33375500bcea98d610eb30ce10ac4e59b89c390d`.
> Licence : Apache-2.0, `LICENSE.txt` à côté. **Modifiée** : ce bloc ajouté en tête ;
