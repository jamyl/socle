...
| `.claude/agents/*` | sous-agents en lecture ou en écriture | Ils **ne connaissent pas** le backlog, le journal, ni les règles ci-dessus : leur travail passe par les mêmes tests et la même revue que le tien |
